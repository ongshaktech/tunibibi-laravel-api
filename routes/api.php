...
//    Route::post("/add-logo/{id}",[\App\Http\Controllers\Seller::class,"LogoUpdate"]);
    ...
    Route::get("/my_currency",[SellerRegistrationController::class,"Currency"])->middleware("auth:sanctum");
...
//        storage/payment/method/
        ...
        Route::get("/orders/confirm_payment/{id}",[\App\Http\Controllers\Admin\OrderController::class,"VerifyOrderPayment"]);
